...
const supabaseUrl = process.env.EXPO_PUBLIC_SUPABASE_URL || 'https://bctwviuitgqyolxabwxq.supabase.co';
const supabaseAnonKey = process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJjdHd2aXVpdGdxeW9seGFid3hxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzIzMjM4MzMsImV4cCI6MjA4Nzg5OTgzM30.PfKJ0zCIKPqSwUkyLZLTAwkbmyZOh_wSOoVbf51wd2Y';
